...
Login to the WebAPI using an API-Key to receive a JWT. The password is optional when performing a login to the WebAPI. The API-Key can be generated by the user using the Manage API-Keys Dialog.
