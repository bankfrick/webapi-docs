...
| type | query | (optional) Filter for transaction type, expected one of (INTERNAL, BANK_INTERNAL, SEPA, SEPA_INSTANT, FOREIGN, QR_BILL). Only relevant for transactions that were created in the context of online banking.	 
