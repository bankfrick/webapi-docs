...
| <a href="https://raw.githubusercontent.com/bankfrick/webapi-docs/master/source/files/pain.001-za7_QR.xml" download>QR Payment</a> |  | IBAN in CH/LI | | CHF/EUR |
...
<aside class="notice">For external payments submitted via pain.001, the creditor postal address fields above are mandatory according to the same rules as <a href="#data-types-transactioncreditoraccount">TransactionCreditorAccount</a>. Mapping: <code>StrtNm</code> → <code>address</code>, <code>BldgNb</code> → <code>buildingNumber</code>, <code>Flr</code> → <code>floor</code>, <code>Room</code> → <code>room</code>, <code>PstCd</code> → <code>postalcode</code>, <code>TwnNm</code> → <code>city</code>, <code>Ctry</code> → <code>country</code>.</aside>
